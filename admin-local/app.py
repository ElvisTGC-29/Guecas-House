...
def article_comments_html(canonical: str, slug: str) -> str:
    return f'''<section class="article-comments" aria-labelledby="article-comments-title"><div class="article-comments-header"><div class="section-kicker">Comunidade Guecas House</div><h2 id="article-comments-title">Converse com respeito</h2><p>Compartilhe sua reflexão sobre o artigo. Comentários ofensivos, discriminatórios, pessoais, publicitários ou fora do tema podem ser removidos. <a href="../politica-comentarios.html">Conheça as regras de convivência</a>.</p></div><div id="disqus_thread" data-page-url="{canonical}" data-page-identifier="artigo-{slug}"><p class="article-comments-loading">Carregando comentários…</p></div><noscript>Ative o JavaScript para visualizar e publicar comentários.</noscript></section>'''
...
def generate_posts_legacy() -> None:
    ...
    for post in posts:
        ...
        comments = article_comments_html(canonical, slug)
